...
*/
// Add User Role
groupMgmtRouterUser.post("/user", authorizationMW_1["default"].defineRoutePermissions({
    user: [],
...
*/
// Get User Group Data
groupMgmtRouterUser.get("/user/:username", authorizationMW_1["default"].defineRoutePermissions({
    user: [],
...
//# sourceMappingURL=groupMgmtRouterUser%20copy.js.map