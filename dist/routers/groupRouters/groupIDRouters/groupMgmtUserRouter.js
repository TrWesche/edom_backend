...
*/
// Add User Role
groupUserMgmtRouter.post("/user", authorizationMW_1["default"].defineRoutePermissions({
    user: [],
...
*/
// Get User Group Data
groupUserMgmtRouter.get("/user/:username", authorizationMW_1["default"].defineRoutePermissions({
    user: [],
...
//# sourceMappingURL=groupMgmtUserRouter.js.map