...
var userRobotRouter = express.Router();
...
*/
userRobotRouter.post("/create", siteMW_1["default"].defineActionPermissions(["view", "create"]), authorizationMW_1["default"].validatePermissions, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_c.label) {
            case 0:
                ...
                if (!((_a = req.user) === null || _a === void 0 ? void 0 : _a.id)) {
                    throw new expresError_1["default"]("Must be logged in to create a robot", 400);
                }
                ...
                return [4 /*yield*/, robotModel_1["default"].create_user_robot((_b = req.user) === null || _b === void 0 ? void 0 : _b.id, regValues)];
            case 1:
                queryData = _c.sent();
                if (!queryData) {
...
/* ____  _____    _    ____
  ...
  |_| \_\_____/_/   \_\____/
*/
userRobotRouter.get("/p/:robotID", siteMW_1["default"].defineActionPermissions(["view"]), authorizationMW_1["default"].validatePermissions, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
...
*/
userRobotRouter.patch("/p/:robotID", siteMW_1["default"].defineActionPermissions(["view", "update"]), authorizationMW_1["default"].validatePermissions, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
...
*/
userRobotRouter["delete"]("/p/:robotID", siteMW_1["default"].defineActionPermissions(["view", "delete"]), authorizationMW_1["default"].validatePermissions, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var queryData;
    var _a, _b;
    return __generator(this, function (_c) {
        try {
...
exports["default"] = userRobotRouter;
//# sourceMappingURL=userRobotRouter.js.map