    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                if (!(0, userEquipCreateSchema_1["default"])(regValues)) {
                    throw new expresError_1["default"]("Unable to Create User Robot: ".concat(userEquipCreateSchema_1["default"].errors), 400);
                }
                return [4 /*yield*/, equipModel_1["default"].create_group_robot((_b = req.user) === null || _b === void 0 ? void 0 : _b.id, req === null || req === void 0 ? void 0 : req.groupID, regValues)];
            case 1:
                queryData = _c.sent();
                if (!queryData) {
...
/* ____  _____    _    ____
  ...
  |_| \_\_____/_/   \_\____/
*/
groupEquipRouter.get("/p/:robotID", groupMW_1["default"].defineActionPermissions(["view"]), authorizationMW_1["default"].validatePermissions, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var queryData, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, equipModel_1["default"].retrieve_robot_by_robot_id(req.params.robotID)];
            case 1:
                queryData = _a.sent();
                if (!queryData) {
...
*/
groupEquipRouter.patch("/p/:robotID", groupMW_1["default"].defineActionPermissions(["view", "update"]), authorizationMW_1["default"].validatePermissions, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, equipModel_1["default"].modify_robot(req.params.robotID, itemsList_1)];
            case 2:
                newData = _a.sent();
...
*/
groupEquipRouter["delete"]("/:robotID", groupMW_1["default"].defineActionPermissions(["view", "delete"]), authorizationMW_1["default"].validatePermissions, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var queryData;
    var _a, _b;
    return __generator(this, function (_c) {
        try {
            ...
            queryData = equipModel_1["default"].delete_user_robot((_b = req.user) === null || _b === void 0 ? void 0 : _b.id, req.params.robotID);
            if (!queryData) {
...
//# sourceMappingURL=groupDeviceRouter.js.map